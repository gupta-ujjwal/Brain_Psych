...
public class Q1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        RadioButton answer;
        final String Answers[] = {"Every day", "Sometimes", "Once", "Never"};
        final String questions[] = new String[5];
        questions[0] = "Have you ever become violent/aggressive when feeling upset or distraught?";
        questions[1] = "Sometimes";
        questions[2] = "Every day";
        questions[3] = "Never";
        questions[4] = "Once";
        score = 0;
        String ans;
